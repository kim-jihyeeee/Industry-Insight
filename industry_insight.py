...
# 1. 설정 및 AI 초기화
st.set_page_config(page_title="AE Total Tool v16.0", layout="wide")
...
# --- 사이드바 ---
menu = st.sidebar.radio("메뉴 선택", ["🌐 AI Trend Radar", "📂 광고주 DB 관리", "📝 관리 이력 입력", "📊 내부 소통 이슈 리포트"])
...
if menu == "🌐 AI Trend Radar":
    ...
    for i, t in enumerate([t1, t2]):
        with t:
            ...
            p = c2.selectbox("기간", ["3일", "7일", "한달", "60일", "분기"], index=3, key=
