...
# 1. 설정 및 AI 초기화
st.set_page_config(page_title="AE Total Tool v22.3", layout="wide")
...
def create_wc(data, h=500):
    ...
    sw = ["뉴스", "제목", "기자", "통해", "대한", "관련", "위해", "있는", "지난", "이번", "제공", "사진", "최근", "대해", "따라", "포함", "경우", "다양한"]
...
# --- 메뉴 ---
menu = st.sidebar.radio("AE Total Tool 메뉴", ["🌐 Radar", "📂 DB 관리", "📝 이력 입력", "📊 리포트"])
